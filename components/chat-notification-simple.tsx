...
export default function ChatNotificationSimple({ onOpenChat }: ChatNotificationProps) {
  ...
  return (
    <Card className="fixed bottom-24 right-6 z-40 w-72 shadow-lg border border-gray-200 bg-white">
