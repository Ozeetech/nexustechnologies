    ...
    try {
      ...
      if (formData.email && formData.password.length >= 6) {
        addToast({
          ...
          description: "Welcome back to NEXUS TECHNOLOGIES",
          type: "success",
        })
  ...
  return (
    <div className="flex min-h-screen">
      <div className="hidden lg:block lg:w-1/2 bg-purple-600 relative">
        <ReliableImage
          src="https://source.unsplash.com/random/800x1000?tech,support,office"
          alt="NEXUS TECHNOLOGIES technical support"
          layout="fill"
          objectFit="cover"
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-xl text-white">
            <h2 className="text-3xl font-bold mb-6">Welcome to NEXUS TECHNOLOGIES</h2>
            <p className="text-lg opacity-90">
              Access your account to manage your IT services, view support tickets, and connect with our technical team.
            </p>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <p className="text-center text-sm text-gray-600">
                  ...
                  <Link href="/register" className="font-medium text-purple-600 hover:text-purple-800 hover:underline">
                    Create one
                  </Link>
                </p>
              </CardFooter>
